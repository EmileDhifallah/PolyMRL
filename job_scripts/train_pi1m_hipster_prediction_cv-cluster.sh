...
#SBATCH --job-name=prediction_cv-cluster
#SBATCH --output=/home/14044994/test/Repos/e3_diffusion_for_molecules/script_outputs/predicting_cv_out_%j-cv-cluster.log
#SBATCH --error=/home/14044994/test/Repos/e3_diffusion_for_molecules/script_outputs/predicting_cv_err_%j-cv-cluster.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
data_list=("Egc") # "Nc" "EPS" "Egb" "Eea" "Xc" "Ei" "Eat" )
split_list=("2") # "1" "2" "3")
