...
#SBATCH --job-name=prediction_cv-no-cluster
#SBATCH --output=/home/14044994/test/Repos/e3_diffusion_for_molecules/script_outputs/predicting_pi1m_out_%j-cv-no-cluster.log
#SBATCH --error=/home/14044994/test/Repos/e3_diffusion_for_molecules/script_outputs/predicting_pi1m_err_%j-cv-no-cluster.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
