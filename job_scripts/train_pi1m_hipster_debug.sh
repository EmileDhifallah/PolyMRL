...
#SBATCH --job-name=final_model_combined_PI1M-weightdecay_loaded-QM9-encoders
...
# python -m main_pi1m --datadir pi1m/temp --cls_rep_3d mean_pool --reflection_equiv True --pretrain_checkpoint_dir_1d outputs/final_model_1d_QM9-weightdecay_epoch_1 --pretrain_checkpoint_dir_3d outputs/final_model_3d_QM9-weightdecay_epoch_1 --dataset qm9 --train_mode pretrain --weight_decay 0.01 --n_epochs 15  --exp_name final_model_combined_QM9-weightdecay-loaded-QM9-encoders-15ep --n_stability_samples 1000 --wandb_usr emiledhifallah --diffusion_noise_schedule polynomial_2 --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --batch_size 32 --nf 256 --n_layers 9 --lr 1e-4 --normalize_factors [1,4,10] --test_epochs 1 --ema_decay 0.9999
...
python -m main_pi1m --datadir pi1m/mmpolymer_data_new/PI1M --mixed_precision_training False --amp_dtype 32 --cls_rep_3d mean_pool --reflection_equiv True --dataset PI1M --train_mode pretrain --weight_decay 0.01 --n_epochs 15 --exp_name final_model_combined_PI1M_no-amp_no-loaded-encoders-15ep --n_stability_samples 1000 --wandb_usr emiledhifallah --diffusion_noise_schedule polynomial_2 --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --batch_size 16 --nf 256 --n_layers 9 --lr 1e-4 --normalize_factors [1,4,10] --test_epochs 1 --ema_decay 0.9999

# PI1M_mean_pool_comb_refl_false_diagn_contr_full_contr_test-2
# QM9_mean_pool_3d_diagn_new_norm
